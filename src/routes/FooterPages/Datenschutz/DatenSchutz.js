  ...
  return (
    <div className="datenschutz">
      <div className="container">
        ...
        <p>
          Wir nutzen Contentful, eine Content-Management-Plattform, um bestimmte
          personenbezogene Daten wie Name, Bild und die berufliche Stellung von
          Mitarbeitern zu speichern und darzustellen. Diese Daten werden
          ausschließlich zu Zwecken der Darstellung auf unserer Website
        ...
        <p>
          Im Hinblick auf Cookies und Tracking-Technologien setzen wir das
          Klaro-Tool ein. Dieses ermöglicht es Ihnen, Ihre Einwilligung zur
          Nutzung von Cookies auf unserer Website zu erteilen oder abzulehnen.
          So können Sie entscheiden, welche Arten von Cookies auf Ihrem Gerät
          gespeichert werden.
        </p>{" "}
        <p>
